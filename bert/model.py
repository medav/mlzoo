...
try:
    ...
    print('Warning: transformers not installed. Tokenizers won\'t be available.')
...
bert_tiny_conf = lambda max_seq_len: BertConfig(
    emb_dim=128,
    num_layers=2,
    num_heads=2,
    ff_dim=512,
...
class BertEmbedding(torch.nn.Module):
    ...
    def forward(self, input_ids, seg_ids=None):
        ...
        position_ids = torch.arange(seq_len, device=input_ids.device).expand(1, -1)
