...
def rnnt_load_from_weights(self : model.Rnnt, weights):
...
model.Rnnt.load_from_weights = rnnt_load_from_weights

def rnntmodel_load_from_file(self : model.Rnnt, filename):
    weights = {
...
model.Rnnt.load_from_file = rnntmodel_load_from_file
